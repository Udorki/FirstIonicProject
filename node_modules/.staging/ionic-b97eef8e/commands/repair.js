...
`,
    ...
    npmRepair(project) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            tasks.next(`Removing ${format_1.prettyPath(packageLockFile)}`);
            yield utils_fs_1.unlink(packageLockFile);
            tasks.next(`Removing ${format_1.prettyPath(nodeModulesDir)}`);
    ...
    cordovaRepair(project, runinfo) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (cordova && cordova.enabled) {
                ...
                tasks.next(`Removing ${format_1.prettyPath(platformsDir)}`);
                yield utils_fs_1.removeDirectory(platformsDir);
                tasks.next(`Removing ${format_1.prettyPath(pluginsDir)}`);
